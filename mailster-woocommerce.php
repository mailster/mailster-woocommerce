...
class MailsterWooCommerce {
	...
	public function __construct() {
		...
		register_activation_hook( $this->plugin_dir . '/mailster-woocommerce.php', array( &$this, 'activate' ) );
		register_deactivation_hook( $this->plugin_dir . '/mailster-woocommerce.php', array( &$this, 'deactivate' ) );
	...
	public function get_mailster_settings() {
		...
		return apply_filters( 'woocommerce_mailster_settings', array(
			array(
				'title'	=> '',
				'type'	=> 'title',
				'desc' 	=> '',
	...
	public function notice() {
		$msg = sprintf( __( 'You have to enable the %s to use Mailster for WooCommerce!', 'mailster-woocommerce' ), '<a href="http://rxa.li/mailster?utm_campaign=plugin&utm_medium=link&utm_source=Mailster+for+WooCommerce">Mailster Newsletter Plugin</a>' );
?>
